...
<html class="light" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="https://leblokkmarrakech.com/wp-content/uploads/2021/04/cropped-android-chrome-512x512-2-32x32.png" sizes="32x32" />
        <!-- Fonts -->
        ...
        @yield('styles')
        <link rel="stylesheet" href="{{ asset('assets/grt-responsive-menu.css') }}">
    </head>
    <body class="antialiased bg-black">
        ...
        <script src="{{ asset('assets/grt-responsive-menu.js') }}"></script>
